...
$extension = array("C" => "c", "C++" => "cpp", "C#" => "cs", "Java" => "java", "JavaScript" => "js", "Pascal" => "pas", "Perl" => "pl", "PHP" => "php", "Python" => "py", "Ruby" => "rb");
$brush = array("C" => "c", "C++" => "cpp", "C#" => "csharp", "Java" => "java", "Java", "JavaScript" => "js", "Pascal" => "text", "Perl" => "perl", "PHP" => "php", "Python" => "python", "Ruby" => "ruby");
