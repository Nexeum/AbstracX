...
<script>
    ...
    <form action='?action=register' method='post' onsubmit="return validate_register()">
        ...
        <table>
            <tr>
                <th colspan>Team Information (Compulsary)</th>
                <td class='vdiv'></td>
                <th colspan>Team Member 1 (Compulsary)</th>
            </tr>
            <tr>
                <td>Team Name</td>
                <td><inputname='reg_teamname'></td>
                <td>Full Name</td>
                <td><input name='reg_name1'></td>
            </tr>
            <tr>
                <td>Password</td>
                <td><input name='reg_pass1' type='password'></td>
                <td>Roll Number</td>
                <td><input name='reg_roll1'></td>
            </tr>
            <tr>
                <td>Retype Password</td>
                <td><input name='reg_pass2' type='password'></td>
                <td>Branch</td>
                <td><input name='reg_branch1'></td>
            </tr>
            <tr>
                <td><span>All values (except for the Password) must be a combination of upto 30 characters characters (single and double quotes are not allowed).</span>
                </td>
                <td>Email Address</td>
                <td><input name='reg_email1'></td>
            </tr>
            <tr>
                <td>Team Group</td>
                <td>
                ...
                <td>Phone Number</td>
                <td><input name='reg_phone1'></td>
            </tr>
            <tr>
                <td class='hdiv'></td>
            </tr>
            <tr>
                <th>Team Member 2 (Optional)</th>
                <td class='vdiv'></td>
                <th>Team Member 3 (Optional)</th>
            </tr>
            <tr>
                <td>Full Name</td>
                <td><input name='reg_name2'></td>
                <td>Full Name</td>
                <td><input name='reg_name3'></td>
            </tr>
            <tr>
                <td>Roll Number</td>
                <td><input name='reg_roll2'></td>
                <td>Roll Number</td>
                <td><input name='reg_roll3'></td>
            </tr>
            <tr>
                <td>Branch</td>
                <td><input name='reg_branch2'></td>
                <td>Branch</td>
                <td><input name='reg_branch3'></td>
            </tr>
            <tr>
                <td>EMail Address</td>
                <td><input name='reg_email2'></td>
                <td>EMail Address</td>
                <td><input name='reg_email3'></td>
            </tr>
            <tr>
                <td>Phone Number</td>
                <td><input name='reg_phone2'></td>
                <td>Phone Number</td>
                <td><input name='reg_phone3'></td>
            </tr>
        </table>
        <br>
