...
<table class='faq'>
    <tr>
        <th>What is the Nexeum Online Judge?</th>
    </tr>
    <tr>
        <td>
...
<table class='faq'>
    <tr>
        <th>How does this website actually work?</th>
    </tr>
    <tr>
        <td>
...
<table class='faq'>
    <tr>
        <th>What exactly is the Execution Protocol?</th>
    </tr>
    <tr>
        <td>
            <p>Execution Protocol, as mentioned before, is a script that actually runs submitted programs and judges
                their correctness. The basic functioning of the Execution Protocol can be described as follows :<br></p>
            <ul>
...
<table class='faq'>
    <tr>
        <th>How do I participate here?</th>
    </tr>
    <tr>
        <td>
            <p>The first thing you need to do it register your team using form given on the <a target='new'
                                                                                               href='?display=register'>Registration
...
<table class='faq'>
    <tr>
        <th>What type of platform shall my codes be run on?</th>
    </tr>
    <tr>
        <td>
...
<table class='faq'>
    <tr>
        <th>Can you give an example of kind of the programs we can submit here?</th>
    </tr>
    <tr>
        <td>
            <p>Please refer to and use the <a target='new' href='?display=problem&pid=1'>Squares</a> Problem to test
                ...
                educational reasons, and are available in the following languages : <a target='new'
                                                                                       href='?display=code&rid=1'>C</a>,
                ...
                <a target='new' href='?display=code&rid=6'>Pascal</a>, <a target='new'
                                                                          href='?display=code&rid=7'>Perl</a>, <a
                    target='new' href='?display=code&rid=8'>PHP</a>, <a target='new'
                                                                        href='?display=code&rid=9'>Python</a> and <a
                    target='new' href='?display=code&rid=10'>Ruby</a>. Please remember that there is a 100KB limit on
                the size of the code you can submit.</p>
...
<table class='faq'>
    <tr>
        <th>Why is my program not being Accepted?</th>
    </tr>
    <tr>
        <td>
...
<table class='faq'>
    <tr>
        <th>How is the ranking done here?</th>
    </tr>
    <tr>
        <td>
            <p>The primary basis for ranking teams is their score. In case the score of two teams are equal, then the
                ...
                submiting programs unless you are reasonably sure they will work.</p>
            <!--
...
<table class='faq'>
    <tr>
        <th>What are the different Contest modes you mentioned before?</th>
    </tr>
    <tr>
        <td>
...
<table class='faq'>
    <tr>
        <th>One last thing ... why did you make this?</th>
    </tr>
    <tr>
        <td>
