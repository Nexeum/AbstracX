...
extension = {"Brain": "b", "C": "c", "C++": "cpp", "C#": "cs", "Java": "java", "JavaScript": "js", "Pascal": "pas",
             "Perl": "pl", "PHP": "php", "Python": "py", "Ruby": "rb", "Text": "txt"}
...
def system():
    ...
    if os.popen("find /usr/bin/ -name bf").read() != "":
        languages.append("Brain")
    ...
    if os.popen("find /usr/bin/ -name js").read() != "":
        languages.append("JavaScript")
    if os.popen("find /usr/bin/ -name mcs").read() != "":
        languages.append("C#")
    if os.popen("find /usr/bin/ -name fpc").read() != "":
        languages.append("Pascal")
    if os.popen("find /usr/bin/ -name perl").read() != "":
        languages.append("Perl")
    if os.popen("find /usr/bin/ -name php").read() != "":
        languages.append("PHP")
    if os.popen("find /usr/bin/ -name python3").read() != "":
        languages.append("Python")
    if os.popen("find /usr/bin/ -name ruby").read() != "":
...
def create(codefilename, language):
    ...
    if language == "C":
        ...
        if not os.path.exists("env/" + codefilename + ".class"):
            result = "CE"
...
def execute(exename, language):
    ...
    running = 1
    if language == "Brain":
        os.system("bf env/" + exename + ".b" + ioeredirect)
    elif language == "C":
        os.system("env/" + exename + ioeredirect)
    elif language == "C++":
        os.system("env/" + exename + ioeredirect)
    elif language == "C#":
        os.system("mono env/" + exename + ".exe" + ioeredirect)
    elif language == "Java":
        os.system("java -client -classpath env " + codefilename + ioeredirect)
    elif language == "JavaScript":
        os.system("rhino -f env/" + codefilename + ".js" + ioeredirect)
    elif language == "Pascal":
        os.system("env/" + exename + ioeredirect)
    elif language == "Perl":
        os.system("perl env/" + exename + ".pl" + ioeredirect)
    elif language == "PHP":
        os.system("php -f env/" + exename + ".php" + ioeredirect)
    elif language == "Python":
        os.system("python env/" + exename + ".py" + ioeredirect)
    elif language == "Ruby":
        os.system("ruby env/" + exename + ".rb" + ioeredirect)
    running = 0
    endtime = time.time()
